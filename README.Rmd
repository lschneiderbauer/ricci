...
{ricci} uses [calculus](https://calculus.eguidotti.com/) package [@guidotti2022] behind the scenes to perform calculations and simply provides an alternative interface to a subset of its functionality.
