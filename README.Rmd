...
Under the hood calculations are performed using the [calculus](https://calculus.eguidotti.com/) package [@guidotti2022]. ricci provides an alternative interface to some of its functionality.
