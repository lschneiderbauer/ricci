...
{ricci} uses the [calculus](https://calculus.eguidotti.com/) package [@guidotti2022] behind the scenes to perform calculations to provide an alternative interface to a subset of its functionality. Notably, {[calculus](https://calculus.eguidotti.com/)} also supports symbolic calculations which also enables {ricci} to do the same.
