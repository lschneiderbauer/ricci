...
Under the hood calculations are performed using the [calculus](https://calculus.eguidotti.com/)[^1] package.
...
Simply creating labels is not very interesting. The act of labeling a tensor becomes useful when the labels are such that they trigger and implicit calculation, or they are combined with other tensors via multiplication or addition.
